...
too: the blog added in [0002](0002-blog-in-same-repo-content-collections.md)
...
- Zero-JS-by-default components and first-class Markdown/content
  ...
  ([0002](0002-blog-in-same-repo-content-collections.md)) was solved inside
...
- [0002](0002-blog-in-same-repo-content-collections.md) — a later content
