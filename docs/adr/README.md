...
| [2026-09-13](2026-09-13-trunk-based-branching-pr-only.md) | Trunk-based development, PR-only workflow | Superseded by [2026-09-15](2026-09-15-trunk-based-development-squash-merge.md) |
...
| [2026-09-24](2026-09-24-local-copilot-worklog.md) | Automatic local consulting worklog for GitHub Copilot CLI sessions | Accepted |
